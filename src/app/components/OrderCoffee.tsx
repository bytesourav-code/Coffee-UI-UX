      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 items-center py-10 max-w-4xl mx-auto">
        ...
        <div className="ml-6 md:ml-10">
          ...
          <p className="text-base md:text-lg text-gray-500 py-2">
            ...
            aliquam consequuntur porro labore voluptatem odio voluptatum dolor
            vero qui. Quaerat.
          </p>
          <Button className="bg-gray-900 text-white px-6 py-3 rounded-lg shadow-lg mt-4 md:mt-10">
            ORDER NOW
          </Button>
        </div>
      </div>
